...
### Instalação
Execute: `python3 setup/setup/check_prerequisites.py + setup/setup_base.py`
...
### Como você vai usar no dia-a-dia
Modo rápido (5 nichos) ou profundo (8-12 perguntas com autosave)
...
### Instalação
Execute: `python3 setup/setup/setup_briefing.py`
...
### Como você vai usar no dia-a-dia
3 arquétipos pré-fab ou criar do zero via skills locais
...
### Instalação
Execute: `python3 setup/setup/setup_design_system.py`
...
### Instalação
Execute: `python3 setup/setup/setup_copy.py`
...
### Instalação
Execute: `python3 setup/setup/setup_lp_build.py`
...
### Instalação
Execute: `python3 setup/setup/setup_cloudflare.py`
...
### Instalação
Execute: `python3 setup/setup/setup_minicrm.py`
...
### Instalação
Execute: `python3 setup/setup/setup_chat_ia.py`
...
### Instalação
Execute: `python3 setup/setup/setup_deploy.py`
